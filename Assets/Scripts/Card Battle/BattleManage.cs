...
public class BattleManage : MonoBehaviour
{
    ...
    void EndBattle() //modified to display a win panel for the rewards. 
    {
        ...
        float itemDropChance = 1.0f; //20% chance enemy will drop card as a bonus reward
        float whetstoneDropChance = 1.0f; //50% chance enemy will drop whetstone as a bonus reward
